...
A [timoni.sh](http://timoni.sh) module for deploying argocd to Kubernetes clusters.
...
```shell
timoni -n default apply argocd oci://<container-registry-url>
```
...
```shell
timoni -n default delete argocd
```
