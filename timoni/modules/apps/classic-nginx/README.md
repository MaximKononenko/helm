...
A [timoni.sh](http://timoni.sh) module for deploying demo-app to Kubernetes clusters.
...
```shell
timoni -n default apply demo-app oci://<container-registry-url>
```
...
```shell
timoni -n default delete demo-app
```
