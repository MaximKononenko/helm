# classic-frontend-backend

A [timoni.sh](http://timoni.sh) module for deploying classic-frontend-backend to Kubernetes clusters.
...
```shell
timoni -n default apply classic-frontend-backend oci://<container-registry-url>
```
...
```shell
timoni -n default delete classic-frontend-backend
```
