...
// Values used by debug_tool.cue for quick module testing.
// Usage: cue cmd -t debug -t name=vm-debug -t namespace=default build
values: {
	...
	names: {
		...
		vm:               "vm-debug-test"
		networkInterface: "vm-debug-test-nic"
		publicIP:         "vm-debug-test-pip"
	}
