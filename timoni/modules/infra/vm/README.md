...
A [timoni.sh](http://timoni.sh) module for deploying vm to Kubernetes clusters.
...
```shell
timoni -n default apply vm oci://<container-registry-url>
```
